...
# run_complete_pipeline.R (JIMR Final Pipeline)
# HCC ferroptosis signature main pipeline for JIMR submission.
...
message("================================================================================")
message("HCC ferroptosis signature analysis - JIMR final pipeline")
message("================================================================================")
...
source("scripts_final/07a_fig2_jimr_deg_ferroptosis.R")
