...
This repository intentionally does not redistribute large raw downloads (GEO/TCGA) or large third-party pharmacogenomic matrices. The analysis scripts expect those resources to be prepared under `HCC_Ferroptosis_Project/` using the same relative paths as documented below.
