...
1) **Module 1 — Data & Resources**
   ...
   - External validation: **TCGA-LIHC**, **GSE76427**, **GSE10143-HCC**, **GSE27150**
...
3) **Module 3 — Prognostic Signature (Discovery → Validation)**
   ...
   - Robustness/diagnostics (Supplementary callout box): Schoenfeld PH test + RMST (60 months) + random-signature sanity check (1000 iterations)
